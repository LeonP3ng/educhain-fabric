...
public interface UserServiceInterface {
    User checkStudentLogin(String var1, String var2);

    int updateUser(User var1);

    User getUser(String var1);

    Map<String, Object> getStudentInfo(String var1, int var2, int var3);

    Page getStudentCompetition(String var1, int var2, int var3);

    Page getStudentExam(String var1, int var2, int var3);

    Page getStudentInternship(String var1, int var2, int var3);
